...
let RestService = class RestService {
    ...
    createStudent(name, email, password, profile, classs, rollno) {
    ...
    createTeacher(name, email, password, profile, designation) {
        return this.http.post(this.URL, {
            user: {
                name: name,
                email: email,
    ...
    createLibrarian(name, email, password, profile) {
        return this.http.post(this.URL, {
            user: {
                name: name,
                email: email,
