...
module.exports = "<h1 class=\"title\">School App</h1>\n\n<form class=\"center\" [formGroup]=\"loginForm\" (ngSubmit)=\"login($event)\">\n  <label for=\"email\">Your Email</label><br>\n  <input type=\"email\" formControlName=\"email\" id=\"email\" name=\"email\"><br>\n  <label for=\"password\">Your Password</label><br>\n  <input type=\"password\" formControlName=\"password\" id=\"password\" name=\"password\"><br>\n  <button >Login</button>\n</form>\n"
...
module.exports = ".title{\n  text-align: center;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_5__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].firebase),
...
let DbService = class DbService {
     ...
     */
    getProfile(userId) {
        return this.db.object('users/' + userId).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((user) => {
            return user.profile;
        }));
    }
};
...
let HomeComponent = class HomeComponent {
    constructor(router, authService, dbService) {
        this.router = router;
    ...
    ngOnInit() {
        ...
        if (this.authService.isLoggedIn()) {
            ...
            this.dbService.getProfile(uid).subscribe((profile) => {
                switch (profile) {
                    case 'admin':
...
module.exports = ".title{\n  text-align: center;\n}\n\n.center{\n  margin: 0 auto;\n  width: 30%;\n}\n\ninput{\n  width: 100%;\n  padding: 10px;\n}\n\nbutton{\n  padding: 10px;\n  width: 100%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
const environment = {
    firebase: {
        apiKey: "AIzaSyA154tAype2eHhlrES6IDinRPUWgK_VmBc",
        authDomain: "schoolapp-8f7a1.firebaseapp.com",
        databaseURL: "https://schoolapp-8f7a1.firebaseio.com",
        projectId: "schoolapp-8f7a1",
        storageBucket: "",
        messagingSenderId: "1030825112591",
        appId: "1:1030825112591:web:9d9ae7d6db634f84"
    },
    production: false
};
/*
...
module.exports = __webpack_require__(/*! /Users/nuttygeek/Desktop/SchoolApp/SchoolApp/SchoolApp/src/main.ts */"./src/main.ts");
